...
### CURRYING — каррінг, -а, _чол._

>[ˈkɝriːɪŋ] - ['кьорінг]

***Каррінг***, ***карріфікація*** - процес перетворення функції, яка очікує кілька аргументів, на послідовність функцій, які очікують по одному аргументу. Прийом використовується у функціональному програмуванні. 
