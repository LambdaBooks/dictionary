...
Алфавітний покажчик: [A](#a) [B](#b) C D E F G H I J K L M [N](#n) O P Q R S T U [V](#v) W X Y Z
...
**майже стандартний режим**, **неповний стандартний режим** — в HTML, режим інтерпретації та відображення сторінки, в якому браузер цілеспрямовано відходить від стандартів (як при режимі сумісності) лише для окремих особливих випадків, використовується для сторінок з перехідними типами документів HTML 4 та XHTML 1.
...
**Створення власного простору імен у вже існуючому глобальному** — у багатьох мовах програмування, техніка створення простору імен використовується для уникнення конфліктів з іншими об'єктами чи змінними у глобальному просторі імен. Деякі техніки створення наведені у [статті](https://addyosmani.com/blog/essential-js-namespacing/) Едді Османі.
